...
{
private EditText KullanıcıAdıEt;
...
private TextView sifremiunuttum;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        KullanıcıAdıEt=findViewById(R.id.KullanıcıAdı);
    ...
    private void Login()
    {
        String KullanıcıAdı=KullanıcıAdıEt.getText().toString();
        String Parola=ParolaEt.getText().toString();
        if (TextUtils.isEmpty(KullanıcıAdı))
        {
            KullanıcıAdıEt.setError("Email Giriniz");
            return;
        }
